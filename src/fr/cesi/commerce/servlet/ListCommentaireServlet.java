 ...
 */
@WebServlet("/listCommentaire")
public class ListCommentaireServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListCommentaireServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*try {
		 ...
		 JpaCommentaireDao projetDao = (JpaCommentaireDao)DaoFactory.getCommentaireDao() ;
		 List<Commentaire> commentaires = projetDao.getAllCommentaires() ;
		 request.setAttribute("Commentaires", commentaires);
		 ServletContext context = getServletContext();
		 RequestDispatcher dispatcher = context.getRequestDispatcher("/listCommentaire.jsp");
